...
//       // Actualizar el estado local con los nuevos datos editados
//       dispatch(updateUserProfile({ name: editedName, email: editedEmail, phone: editedPhone }));
...
export const Profile = () => {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      // Usar dispatch para enviar la acción a Redux y actualizar el estado local
      dispatch(
        updateUserProfile({
          name: editedName,
          email: editedEmail,
