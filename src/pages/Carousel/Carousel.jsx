...
import "./Carousel.css";
import { carouselImages } from "../../common/Utils/index"
...
export const Carousel = () => {
  ...
  const handleProgressBarClick = (event) => {
    ...
    const newIndex = Math.round((clickedPercentage / 100) * (carouselImages.length - 1));
  ...
  const ProgressBar = ({ index }) => {
    const progressWidth = (index / (carouselImages.length - 1)) * 100;
